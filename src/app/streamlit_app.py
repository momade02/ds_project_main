...
# --- Permanent layout debug overlay + reduced top whitespace ---
    st.markdown(
       ...
       /* Map section header (force title + subtitle on separate lines) */
        ...
        /* 1) Reduce space above/below sidebar headings (Route, Fuel type, Detour economics, etc.) */
        ...
        /* 4) Slightly reduce vertical spacing between consecutive widgets in the sidebar */
